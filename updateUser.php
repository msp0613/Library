<?php
    include('dbConnection.php');
      ...
      if(!isset($_SESSION['id'])){
        ...
        $user =  $db->readOne('user',['role','login','password','nameAndSurname','address'],[['id','=',$_SESSION['id']]]);
        $user = json_decode(json_encode ( $user ) , true);
            ...
            if(isset($_POST['submit'])){
                ...
                if(isset($_POST['password'])){
                        ...
                        array_push($arrayValues,password_hash($_POST['password'],PASSWORD_BCRYPT));
                ...
                if(isset($_POST['nameAndSurname'])){
                    if($user['nameAndSurname'] != $_POST['nameAndSurname']){
